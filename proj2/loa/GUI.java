...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Game->White AI", this::whiteAi);
        addMenuButton("Game->White Manual", this::whiteManual);
        addMenuButton("Game->Black AI", this::blackAi);
        addMenuButton("Game->Black Manual", this::blackManual);
    ...
    /** Response to "WhiteAi" button click. */
    private void whiteAi(String dummy) {
        _pendingCommands.offer("whiteai");
    }
    /** Response to "BlackAi" button click. */
    private void blackAi(String dummy) {
        _pendingCommands.offer("blackai");
    }
    /** Response to "whiteManual" button click. */
    private void whiteManual(String dummy) {
        _pendingCommands.offer("whitemanual");
    }
    /** Response to "BlackManual" button click. */
    private void blackManual(String dummy) {
        _pendingCommands.offer("blackmanual");
    }
