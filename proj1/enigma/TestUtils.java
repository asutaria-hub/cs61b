...
class TestUtils {
    ...
    static final ArrayList<Rotor> ROTORLIST = new ArrayList<>();
    static {
        ROTORLIST.add(new Reflector("B", new Permutation("(AE) (BN) (CK) "
                + "(DQ) (FU) (GY) (HW) (IJ) (LO) (MP) (RX) (SZ) (TV)", UPPER)));
        ROTORLIST.add(new FixedRotor("BETA", new Permutation("(ALBEV"
                + "FCYODJWUGNMQTZSKPR) (HIX)", UPPER)));
        ROTORLIST.add(new MovingRotor("I", new Permutation("(AEL"
                + "TPHQXRU) (BKNW) (CMOY) (DFG) (IV) (JZ) (S)", UPPER), "Q"));
        ROTORLIST.add(new MovingRotor("II", new Permutation("(FIXVYOMW)"
                + " (CDKLHUP) (ESZ) (BJ) (GR) (NT) (A) (Q)", UPPER), "E"));
        ROTORLIST.add(new MovingRotor("III", new Permutation("(ABDHPEJT)"
                + " (CFLVMZOYQIRWUKXSG) (N)", UPPER), "V"));
        ROTORLIST.add(new MovingRotor("IV", new Permutation("(AEPL"
                + "IYWCOXMRFZBSTGJQNH) (DV) (KU)", UPPER), "J"));
    }
